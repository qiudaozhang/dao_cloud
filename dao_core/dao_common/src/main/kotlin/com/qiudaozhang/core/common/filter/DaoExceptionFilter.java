package com.qiudaozhang.core.common.filter;
...
public class DaoExceptionFilter implements Filter, Filter.Listener {
    private Logger logger = LoggerFactory.getLogger(DaoExceptionFilter.class);
    ...
    public void onResponse(Result appResponse, Invoker<?> invoker, Invocation invocation) {
        if (appResponse.hasException() && GenericService.class != invoker.getInterface()) {
            try {
                ...
                if(exception instanceof BizExp) {
                    BizExp be = (BizExp) exception;
                    appResponse.setException(new BizExp(be.getCode(),be.getMessage()));
                } else {
